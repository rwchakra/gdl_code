...
# + torch.normal(mean=0,std=0.0001,size=(training_set_size * n_nodes, coords))
...
# + torch.normal(mean=0,std=0.0001,size=(test_set_size * n_nodes, input_nf))
...
for i in range(max_epoch):
  ...
  for iters in range(len(training_set)):
    ...
    x_1, h_1 =  l_gen.get_labels(type_f2 = 'angles')
  ...
  x_test, h_test =  l_gen_test.get_labels(type_f2 = 'angles')
